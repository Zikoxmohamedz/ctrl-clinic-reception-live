...
function openEditModal(row, branches, allBranches, materials, reload) {
  ...
  form.onsubmit = async event => {
    ...
    if (consumption) {
      ...
      payload.notes = form.notes.value.trim() || null;
